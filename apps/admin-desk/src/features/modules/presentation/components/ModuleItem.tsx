    ...
    return (
        <Card className="group flex h-full flex-col transition-all hover:border-primary hover:shadow-md">
            <CardHeader className="flex flex-row items-center gap-4 space-y-0 pb-3 border-b " >
                ...
                <div className="flex-1 space-y-1 cursor-pointer hover:text-primary transition-colors" onClick={handleSelectedModule}>
                    <CardTitle
            ...
            {canWrite && (
                <CardFooter className="flex justify-end gap-2 pt-2 border-t mt-auto">
                    <Button variant="ghost" size="sm" className="text-muted-foreground hover:text-primary" onClick={handleSelectedModule}>
