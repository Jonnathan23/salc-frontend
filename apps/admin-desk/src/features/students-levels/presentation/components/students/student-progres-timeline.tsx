...
import ModulesSelectedForUpsellItem from "@/features/students-levels/presentation/components/levels/modules-selected-upsell-item";
...
export default function StudentProgressTimeline(props: StudentProgressTimelineProps) {
    ...
    const { selectedStudent, studentLevels, modulesSelectedForUpsell, availableModulesForUpsell, isLoading, isLoadingPurchaseModules
        , cnFunction, handleAddModulesForUpsell, handleRemoveModulesForUpsell, handlePurchaseModules } = props
        ...
        return (
            <>
                ...
                <div>
                    ...
                    <Button onClick={handlePurchaseModules} disabled={modulesSelectedForUpsell.length === 0 || isLoadingPurchaseModules}>
