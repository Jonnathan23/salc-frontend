...
export default function ModulesSelectedForUpsellItem({ module, handleRemoveModulesForUpsell }: ModulesSelectedForUpsellItemProps) {
    ...
    return (
        <div className="flex items-center justify-between rounded-lg border p-3"        >
            ...
            <Button
                size="sm"
                variant="outline"
                onClick={() => handleRemoveModulesForUpsell(module)}
