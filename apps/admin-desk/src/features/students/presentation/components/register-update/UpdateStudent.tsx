...
import { useUpdateStudentForm } from "@/features/students/application/hooks/forms/useUpdateFormStudent.use";
...
export default function UpdateStudent({ studentId, student, assignedSeller, handleSetEdit }: UpdateStudentProps) {
    ...
    const { handleSubmit, isSubmitting, onSubmit, control, register, errors, minDate, maxAllowedDate, certificates } = useUpdateStudentForm({
