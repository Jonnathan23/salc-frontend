...
import UpdateStudent from "@/features/students/presentation/components/register-update/UpdateStudent";
import StudentProfileData from "@/features/students/presentation/components/student-item/StudentProfileData";
...
export default function ViewStudentProfile() {
    ...
    if (isEdit && canUserResponseEdit) return <UpdateStudent
        studentId={studentId} student={student} assignedSeller={userResponse.us_full_name} handleSetEdit={handleSetEdit}
    />
