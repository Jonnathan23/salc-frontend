...
import { useGetAllUsers } from "@/features/indentity/application/hooks/useGetAllUsers.use-case";
                ...
                <table className="w-full text-sm">
                    <thead>
                        <tr className="bg-primary/20">
                            <th className="px-5 py-3 text-left text-xs font-semibold text-primary-foreground uppercase tracking-wide">Usuario</th>                            
                            <th className="px-5 py-3 text-left text-xs font-semibold text-primary-foreground uppercase tracking-wide">Rol</th>
