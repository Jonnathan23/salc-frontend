...
export const RoleInfoCard = ({ selectedRole }: { selectedRole: string }) => (
    <Card>
        ...
        <CardContent className="space-y-4">
            {/* ADMIN */}
            <div className={`rounded-lg border p-4 transition-colors ${selectedRole === userRoles.ADMIN ? 'border-primary bg-primary/5' : ''}`}>
            ...
            {/* ADVISOR */}
            <div className={`rounded-lg border p-4 transition-colors ${selectedRole === userRoles.ADVISOR ? 'border-amber-300 bg-amber-300/5' : ''}`}>
                <div className="flex items-center gap-2">
            ...
            {/* ACADEMIC DIRECTOR */}
            <div className={`rounded-lg border p-4 transition-colors ${selectedRole === userRoles.ACADEMIC_DIRECTOR ? 'border-blue-500 bg-blue-500/5' : ''}`}>
                <div className="flex items-center gap-2">
            ...
            {/* TEACHER */}
            <div className={`rounded-lg border p-4 transition-colors ${selectedRole === userRoles.TEACHER ? 'border-red-300 bg-red-300/5' : ''}`}>
                <div className="flex items-center gap-2">
