...
export default function TuitionStundentPage() {
    ...
    const {
        ...
        minDate,
        certificates,
    } = useRegisterStudentForm();

    return (
        <div className="space-y-6">
            <div className="space-y-1">
                <h2 className="text-2xl font-bold tracking-tight text-foreground">Matrícula de Estudiantes</h2>
                <p className="text-muted-foreground">Registra nuevos estudiantes y asigna módulos de estudio.</p>
            </div>
                ...
                <CardContent>
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div className="flex justify-end pt-4 border-t border-border/50">
                            <Button
                                type="submit"
                                className={`hover:bg-primary/80 w-full md:w-auto ${isSubmitting ? "opacity-50 cursor-not-allowed" : ""}`}
