...
import StudentProgressTimeline from "@/features/admin-desk/students-levels/presentation/components/students/student-progres-timeline";
import SearchStudent from "@/features/admin-desk/students-levels/presentation/components/students/search-student";
...
export default function AdminStudentsLevels() {
    ...
    const { data: responseStudentLevels, isLoading: isLoadingStudentLevels } = useGetAllStudentLevels(
        selectedStudent?.id || "",
    );
