...
export function AccessControlView() {
    const [pendingApprovals, setPendingApprovals] = useState(
        mockSessions.filter((s) => s.attendanceSessionStatus === SessionStatus.PENDING_APPROVAL),
    );
    const [activeSessions] = useState(mockSessions.filter((s) => s.attendanceSessionStatus === SessionStatus.IN_PROGRESS));
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                            ...
                            <table className="w-full text-sm">
                                ...
                                <tbody className="divide-y divide-[var(--color-tertiary)]/15">
                                    ...
                                    {activeSessions.length === 0 && (
                                        <tr>
                                            <td colSpan={4} className="px-5 py-8 text-center text-[var(--color-font)]/40 text-sm">
                    ...
                    <div className="bg-white rounded-xl border border-[var(--color-tertiary)]/30 overflow-hidden">
                        <div className="px-5 py-4 border-b border-[var(--color-tertiary)]/20 flex items-center justify-between">
                            <div>
                                <h2 className="font-semibold text-[var(--color-font)] text-sm">Cola de Salidas Pendientes</h2>
