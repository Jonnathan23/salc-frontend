...
function Carousel({ orientation = "horizontal", opts, setApi, plugins, className, children, ...props }: CarouselComponentProps) {
...
import type { ButtonProps } from "@/core/components/ui/class-track/Button";
export interface CarouselPreviousProps extends ButtonProps {}
function CarouselPrevious({ className, variant = "outline", size = "icon", ...props }: CarouselPreviousProps) {
...
function CarouselNext({ className, variant = "outline", size = "icon", ...props }: CarouselNextProps) {
