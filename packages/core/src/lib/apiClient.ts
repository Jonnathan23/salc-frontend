...
export const api: Api = new ApiAxios("", validateErrorResponse as EntityValidator<ErrorResponse>, "" as ClientContext);

export const setupApiClient = (onUnauthorized: () => void, clientContext: ClientContext): void => {
    if (!envs.API_URL) {
    ...
    api.setClientContext(clientContext);
};
