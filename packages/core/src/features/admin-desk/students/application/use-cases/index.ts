export * from "@salc/core/features/admin-desk/students/application/use-cases/registerStudent.use-case";
export * from "@salc/core/features/admin-desk/students/application/use-cases/searchStudents.use-case";
export * from "@salc/core/features/admin-desk/students/application/use-cases/updateStudent.use-case";
