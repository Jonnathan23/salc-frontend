import {
    GetStudentContractsUseCaseImpl, UpdateStudentLevelUseCaseImpl
    , DeleteStudentLevelUseCaseImpl, PurchaseModulesUseCaseImpl
} from "@salc/core/features/admin-desk/students-level/application/use-cases";

import {
    arrayStudentLevelDetailsSchema, studentLevelDetailsSchema,
    arrayStudentLevelSchema, studentLevelSchema
...
import { StudentLevelDataSourceImpl } from "@salc/core/features/admin-desk/students-level/infrastructure/datasources/student-level.datasource.impl";
import { StudentLevelDetailsMapperImpl, StudentLevelMapperImpl } from "@salc/core/features/admin-desk/students-level/infrastructure/mappers";
...
const studentLevelDetailsValidatorArray = validatorFactory.createValidator<StudentLevelDetailsEntity[]>(arrayStudentLevelDetailsSchema);


//* Mapper
export const studentLevelMapper = new StudentLevelMapperImpl(studentLevelValidator, studentLevelValidatorArray);
export const studentLevelDetailsMapper = new StudentLevelDetailsMapperImpl(studentLevelDetailsValidator, studentLevelDetailsValidatorArray);
